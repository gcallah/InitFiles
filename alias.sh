...
export MISC_DIR=$WRITING_DIR/MiscWriting
export AI_DIR=$MISC_DIR/AI
...
alias emp="cd $MISC_DIR/Empire"
alias emu="cd $HOME/GitProjects/Emu86; . ./act.sh"
alias etl="cd $MIX_DIR/ETL"
alias ff="ff.sh"
alias fin="cd $BUS_DIR/FinsightIndex; . ./act.sh"
alias geo="cd $STUDENT_DIR/geodata2025; . ./act.sh"
alias gg="git grep"
...
alias mans="cd $CLASS_DIR/mansion; . ./act.sh"
