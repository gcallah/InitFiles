...
alias cap="cd $INDRA_HOME/capital; git checkout stagin"
...
alias indl="cd $INDRA_HOME/lib; git checkout stagin"
...
alias mdl="cd $INDRA_HOME/models; git checkout stagin"
...
alias reg="cd $INDRA_HOME/registry; git checkout stagin"
